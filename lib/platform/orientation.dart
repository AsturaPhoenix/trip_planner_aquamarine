...
// from https://github.com/alihadi5125/smooth_compass/blob/master/lib/utils/src/compass.dart
class Orientation {
  ...
  Stream<double> compassUpdates(Duration interval) {
    // ignore: close_sinks
